...
<div class="rowl1">
  <img src="{{ site.url }}{{ site.baseurl }}/images/respic/multi_user_communication.jpg" class="img-responsive" style="float: left; border-radius:10px; width: 280px; height: 170px" />
...
<div class="rowl1">
  <img src="{{ site.url }}{{ site.baseurl }}/images/respic/auditory_feedback_ad.jpg" class="img-responsive" style="float: left; border-radius:10px; width: 280px; height: 170px" />
